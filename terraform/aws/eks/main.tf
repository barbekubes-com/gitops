...
module "eks" {
  ...
  aws_auth_roles = [
    ...
    {
      rolearn  = "arn:aws:iam::126827061464:role/KubernetesAdmin"
      username = "arn:aws:iam::126827061464:role/KubernetesAdmin"
      groups   = ["system:masters"]
    },
    {
      rolearn  = "arn:aws:iam::126827061464:role/argocd-bbkubes-1"
      username = "arn:aws:iam::126827061464:role/argocd-bbkubes-1"
      groups   = ["system:masters"]
    },
    {
      rolearn  = "arn:aws:iam::126827061464:role/atlantis-bbkubes-1"
      username = "arn:aws:iam::126827061464:role/atlantis-bbkubes-1"
      groups   = ["system:masters"]
    },
  ]
  ...
  eks_managed_node_groups = {
    ...
    default_node_group = {
      desired_size = tonumber("5") # tonumber() is used for a string token value
      min_size     = tonumber("5") # tonumber() is used for a string token value
      max_size     = tonumber("5") # tonumber() is used for a string token value
...
module "vpc_cni_irsa" {
  ...
  role_name             = upper("VPC-CNI-IRSA-bbkubes-1")
...
module "aws_ebs_csi_driver" {
  ...
  role_name = upper("EBS-CSI-DRIVER-bbkubes-1")
...
data "aws_iam_policy_document" "crossplane_custom_trust_policy" {
  statement {
    ...
    condition {
      ...
      values   = ["system:serviceaccount:crossplane-system:crossplane-provider-terraform-bbkubes-1"]
    }
